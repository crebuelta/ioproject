...
/* package ioproject-0.1.0.0 */
#ifndef VERSION_ioproject
#define VERSION_ioproject "0.1.0.0"
#endif /* VERSION_ioproject */
#ifndef MIN_VERSION_ioproject
#define MIN_VERSION_ioproject(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ioproject */
...
#define CURRENT_COMPONENT_ID "ioproject-0.1.0.0-inplace-ioproject"

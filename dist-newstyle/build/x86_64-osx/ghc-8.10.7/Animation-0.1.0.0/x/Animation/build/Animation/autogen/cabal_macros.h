...
/* package Animation-0.1.0.0 */
#ifndef VERSION_Animation
#define VERSION_Animation "0.1.0.0"
#endif /* VERSION_Animation */
#ifndef MIN_VERSION_Animation
#define MIN_VERSION_Animation(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Animation */
...
#define CURRENT_COMPONENT_ID "Animation-0.1.0.0-inplace-Animation"
